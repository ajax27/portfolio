  ...
  render() {
    ...
    return (
      <BaseLayout
        ...
        title="Shaun Collins - Latest Blogs to Read"
      >
        <div
          className="masthead"
            ...
            <div className="row">
              <div className="col-lg-8 col-md-10 mx-auto">
                <div className="site-heading">
                  <h1>Latest Blogs</h1>
                  <span className="subheading">Coding, travelling...</span>
                </div>
              </div>
            </div>
          </Container>
                ...
                <div className="col-lg-8 col-md-10 mx-auto">
                  <ul className="list-inline text-center">
                    <li className="list-inline-item">
                      <a
                        target="_blank"
                        href="https://www.facebook.com/shaun.collins.5623"
                      >
                    ...
                    <li className="list-inline-item">
                      <a target="_blank" href="https://github.com/ajax27">
                        <span className="fa-stack fa-lg">
                          <i className="fas fa-circle fa-stack-2x"></i>
